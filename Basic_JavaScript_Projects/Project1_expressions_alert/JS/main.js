...
var x = "10" //Giving a value to a variable

var x = x.fontcolor("red"); //Using the font.color method
                            //on x variable 

document.write(x); //Writing the x variable with "red" fontcolor

document.write(5 + 5); //Demonstrating an expression, 
                       //keeping it in the original text
