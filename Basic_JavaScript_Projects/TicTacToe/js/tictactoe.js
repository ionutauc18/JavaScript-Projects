...
function checkWinConditions() {
    ...
    // And 9 squares are selected, the code executes.
        ...
        audio('./media/tie.mp3');
        // This function sets a one second timer before the resetGame is called.
...
// This function makes our body element temporaly unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        // This method moves us to a starting point for our lines
        c.moveTo(x1, y1);
        // This method indicates the end point in our line
        c.lineTo(x, y);
        // This method set the width of our line
        c.animateLineDrawing = 20;
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            // This condition cancels our animation loop if reach the ends point.
